        ...
        return(
            <div className = "background-main-container" id="about">
                ...
                <p className = "background-desc">
                    ...
                    I have taught over 100 students  Ruby, Ruby on Rails, SQL, JavaScript, React + Redux, and given self-made lectures on essential skills like Git, CSS, pair-programming and problem solving. 
